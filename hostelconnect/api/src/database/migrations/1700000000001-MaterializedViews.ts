...
export class MaterializedViews1700000000001 implements MigrationInterface {
  name = 'MaterializedViews1700000000001';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Live Hostel Dashboard Materialized View
    ...
    // Attendance Session Summary Materialized View
    await queryRunner.query(`
    ...
    // Gate Funnel Daily Materialized View
    await queryRunner.query(`
    ...
    // Meal Forecast Daily Materialized View
    await queryRunner.query(`
    ...
    // Room Occupancy Daily Materialized View
    await queryRunner.query(`
