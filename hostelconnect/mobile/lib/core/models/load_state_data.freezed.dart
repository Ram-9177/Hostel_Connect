...
abstract class _Loading<T> implements LoadState<T> {
...
abstract class _Success<T> implements LoadState<T> {
...
class _$ErrorImpl<T> implements _Error<T> {
  ...
  @override
  String toString() {
    return 'LoadState<$T>.error(message: $message)';
  }
...
abstract class _Error<T> implements LoadState<T> {
