// lib/main.dart - Clean Working Android App
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 16,
              children: [
                _buildFeatureCard('Request Gate Pass', Icons.exit_to_app, Colors.orange),
                _buildFeatureCard('View Attendance', Icons.calendar_today, Colors.blue),
                _buildFeatureCard('Meal Management', Icons.fastfood, Colors.green),
                _buildFeatureCard('Room Information', Icons.bed, Colors.purple),
                _buildFeatureCard('Notices & Updates', Icons.announcement, Colors.blue),
                _buildFeatureCard('Profile', Icons.person, Colors.blue),
              ],
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 16,
              children: [
                _buildFeatureCard('Gate Pass Scanner', Icons.qr_code_scanner, Colors.orange),
                _buildFeatureCard('Student Management', Icons.group, Colors.blue),
                _buildFeatureCard('Attendance Management', Icons.check_circle_outline, Colors.green),
                _buildFeatureCard('Room Allocation', Icons.bed, Colors.purple),
                _buildFeatureCard('Reports & Analytics', Icons.bar_chart, Colors.blue),
                _buildFeatureCard('Broadcast Notice', Icons.announcement, Colors.blue),
              ],
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 16,
              children: [
                _buildFeatureCard('Menu Management', Icons.restaurant_menu, Colors.green),
                _buildFeatureCard('Meal Preparation', Icons.food_bank, Colors.purple),
                _buildFeatureCard('Inventory Management', Icons.inventory, Colors.blue),
                _buildFeatureCard('Meal Feedback', Icons.feedback, Colors.blue),
                _buildFeatureCard('Dietary Requests', Icons.healing, Colors.green),
                _buildFeatureCard('Kitchen Reports', Icons.analytics, Colors.blue),
              ],
            ),
          ],
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 16,
              children: [
                _buildFeatureCard('Admin Dashboard', Icons.dashboard, Colors.indigo),
                ...
                _buildFeatureCard('Reports & Analytics', Icons.bar_chart, Colors.blue),
                _buildFeatureCard('Hostel Management', Icons.home_work, Colors.purple),
                _buildFeatureCard('Security & Access', Icons.security, Colors.red),
              ],
            ),
          ],
        ),
